...
//--------------------------------------------------------------------------------
//Command: generate_target bd_8143.bd
//Design : bd_8143
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_8143,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_8143,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=51,numReposBlks=41,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "NPU_bd_axi_smc_0.hwdef" *) 
module bd_8143
   (M00_AXI_awaddr,
    M00_AXI_awprot,
    M00_AXI_awready,
    ...
    aclk1,
    aresetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M00_AXI AWADDR" *) (* X_INTERFACE_MODE = "Master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M00_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN NPU_bd_clk_wiz_0_0_clk_out1, DATA_WIDTH 32, FREQ_HZ 150079014, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 0, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 8, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 8, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE WRITE_ONLY, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [31:0]M00_AXI_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:S00_AXI, ASSOCIATED_CLKEN m_sc_aclken, CLK_DOMAIN NPU_bd_clk_wiz_0_0_clk_out1, FREQ_HZ 150079014, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK1 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK1, ASSOCIATED_BUSIF S01_AXI:S02_AXI, ASSOCIATED_CLKEN m_sc_aclken, CLK_DOMAIN NPU_bd_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk1;
  ...
  m00_exit_pipeline_imp_1JFWPEX m00_exit_pipeline
  ...
  m00_nodes_imp_16596KL m00_nodes
  ...
  s00_entry_pipeline_imp_J4Y9BE s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_MJLJ1S s00_nodes
  ...
  s01_entry_pipeline_imp_1Q0WNZY s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_1KOT6TI s01_nodes
  ...
  s02_entry_pipeline_imp_1B0GCOZ s02_entry_pipeline
       (.aclk(aclk_3),
        .aresetn(aresetn_4),
  ...
  s02_nodes_imp_1CVTZX9 s02_nodes
  ...
  switchboards_imp_GAINXG switchboards
       (.M00_SC_AR_recv(1'b0),
...
module m00_exit_pipeline_imp_1JFWPEX
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awprot,
...
module s00_entry_pipeline_imp_J4Y9BE
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_8143_s00mmu_0 s00_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_8143_s00sic_0 s00_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
  ...
  bd_8143_s00tr_0 s00_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module s01_entry_pipeline_imp_1Q0WNZY
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_8143_s01mmu_0 s01_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_8143_s01sic_0 s01_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_8143_s01tr_0 s01_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module s02_entry_pipeline_imp_1B0GCOZ
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_8143_s02mmu_0 s02_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_8143_s02sic_0 s02_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_8143_s02tr_0 s02_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module switchboards_imp_GAINXG
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
  ...
  bd_8143_arsw_0 ar_switchboard
       (.aclk(aclk),
        .aclken(1'b1),
        .m_sc_info(\^M00_SC_AR_info ),
        .m_sc_payld(\^M00_SC_AR_payld ),
        .m_sc_recv({M00_SC_AR_recv,M00_SC_AR_recv,M00_SC_AR_recv}),
  ...
  bd_8143_rsw_0 r_switchboard
       (.aclk(aclk),
        ...
        .s_sc_info({S00_SC_R_info,S00_SC_R_info,S00_SC_R_info}),
        .s_sc_payld({S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld,S00_SC_R_payld}),
        .s_sc_recv(\^S00_SC_R_recv ),
        .s_sc_req({S00_SC_R_req,S00_SC_R_req,S00_SC_R_req}),
        .s_sc_send({S00_SC_R_send,S00_SC_R_send,S00_SC_R_send}));
  bd_8143_wsw_0 w_switchboard
       (.aclk(aclk),
        .aclken(1'b1),

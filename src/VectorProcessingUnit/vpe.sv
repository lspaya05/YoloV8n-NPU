...
// Date: 2026-04-27
// This is the Vector Processing Element (VPE).
//
...
module vpe (
    ...
    input  logic [7:0]  data_h_in,
    output logic [7:0]  out
);

    logic [7:0] left_operand;
    logic [7:0] right_operand;
    logic [7:0] fu_out;
    logic [7:0] register_out;

    mux2to1 #(.BIT_WIDTH(8)) left_operand_mux (
        .d0(in_a),
        .d1(data_h_in),
    ...
    mux2to1 #(.BIT_WIDTH(8)) right_operand_mux (
        .d0(in_b),
        .d1(register_out),
    ...
    vpe_reg #(.BIT_WIDTH(8)) local_register (
        .in(fu_out),
        .out(register_out),
        .clk(clk),
    ...
    mux2to1 #(.BIT_WIDTH(8)) output_mux (
        .d0(fu_out),
        .d1(register_out),
